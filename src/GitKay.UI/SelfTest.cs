...
public static class SelfTest {
    public static int Run(string repositoryPath) {
        ...
        Check("settings round-trip through the Reified codec", () => {
            ...
            var settings = new GitKay.Core.Settings(true, true, 7, GitKay.Core.DiffLayout.SideBySide, "Inter", "Iosevka", 14.5, 12, 10, 0.25, GitKay.Core.ThemeMode.DarkTheme, 4.0, GitKay.Core.PaneHoverEffect.HoverShadow, GitKay.Core.PaneHoverColor.PurpleHoverColor);
